 ...
 * Generated at: 2020-05-10 16:47:34 UTC
...
public final class listaaasiakkaat_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<thead>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th colspan=\"7\" class=\"oikealle\"><span id=\"uusiAsiakas\">Lisää uusi asiakas</span></th>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th class=\"oikealle\" colspan=\"2\">Hakusana:</th>\r\n");
      out.write("\t\t\t<th colspan=\"3\"><input type=\"text\" name=\"haku\" id=\"haettava\" size=\"20\"></th>\r\n");
      out.write("\t\t\t<th colspan=\"2\"><input type=\"submit\" value=\"Hae\" id=\"hakunappi\"></th>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("  \t\t<tr>\r\n");
      out.write("  \t\t\t<th>ID</th>\r\n");
      ...
      out.write("\t$.ajax({url:\"asiakkaat/\"+$(\"#haettava\").val(), type:\"GET\", dataType:\"json\", success:function(result) {\r\n");
      out.write("\t\t$.each(result.asiakkaat, function(i, field) {\r\n");
      out.write("\t\t\tvar htmlStr;\r\n");
      out.write("\t\t\thtmlStr+=\"<tr id='rivi_\"+field.id+\"'>\";\r\n");
      out.write("\t\t\thtmlStr+=\"<td>\"+field.id+\"</td>\";\r\n");
      ...
      out.write("\t\t\thtmlStr+=\"<td><a href='muutaasiakas.jsp?id=\"+field.id+\"'>Muuta</a>&nbsp;\"; \r\n");
      out.write("\t\t\thtmlStr+=\"<td><span class='poista' onclick=poista('\"+field.id+\"')>Poista</span></td>\";\r\n");
      out.write("\t\t\thtmlStr+=\"</tr>\";\r\n");
      out.write("\t\t\t$(\"#listaus tbody\").append(htmlStr);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}});\r\n");
      out.write("}\r\n");
      out.write("function poista(id) {\r\n");
      out.write("\tif (confirm(\"Poista asiakas, jonka id on \" + id +\"?\")) {\r\n");
      out.write("\t\t$.ajax({url:\"asiakkaat/\"+id, type:\"DELETE\", dataType:\"json\", success:function(result) {\r\n");
      out.write("\t\t\tif (result.response == 0) {\r\n");
      out.write("\t\t\t\t$(\"#ilmoitus\").html(\"Asiakkaan poisto epäonnistui.\");\r\n");
      out.write("\t\t\t} else if (result.response == 1) {\r\n");
      out.write("\t        \talert(\"Asiakas \" + id +\" poisto onnistui.\");\r\n");
      out.write("\t\t\t\thaeAsiakkaat();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}});\r\n");
      out.write("\t}\r\n");
